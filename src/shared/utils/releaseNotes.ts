...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/batuhanozkose/OzRouter/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/batuhanozkose/OzRouter/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/batuhanozkose/OzRouter/blob/main/CHANGELOG.md";
