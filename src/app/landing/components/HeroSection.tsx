...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-32 pb-20 px-4 sm:px-6 min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      {/* Glow effect */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-[#7289DA]/10 rounded-full blur-[120px] pointer-events-none"></div>

      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center gap-8">
        {/* Version badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#2D333B] bg-[#111520]/50 px-3 py-1 text-xs font-medium text-[#7289DA]">
          <span className="flex h-2 w-2 rounded-full bg-[#7289DA] animate-pulse"></span>
          {t("versionLive")}
        </div>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black leading-[1.1] tracking-tight break-words">
          {t("oneEndpoint")} <br />
          <span className="text-[#7289DA]">{t("allProviders")}</span>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 w-full">
          <button
            ...
            className="w-full sm:w-auto h-12 px-8 rounded-lg bg-[#7289DA] hover:bg-[#5a72c9] text-white text-base font-bold transition-all shadow-[0_0_15px_rgba(114,137,218,0.4)] flex items-center justify-center gap-2"
          >
