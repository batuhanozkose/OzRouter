    ...
    <section className="py-24 border-y border-[#2D333B] bg-[#111520]/30" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-[2px] bg-linear-to-r from-gray-700 via-[#7289DA] to-gray-700 -z-10"></div>
          ...
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            <div className="w-24 h-24 rounded-2xl bg-[#0B0E14] border-2 border-[#7289DA] flex items-center justify-center shadow-[0_0_30px_rgba(114,137,218,0.2)] z-10 mx-auto">
              <span
                className="material-symbols-outlined text-4xl text-[#7289DA] animate-pulse"
                aria-hidden="true"
              >
                hub
              </span>
            ...
            <div>
              <h3 className="text-xl font-bold mb-2 text-[#7289DA] break-words">
