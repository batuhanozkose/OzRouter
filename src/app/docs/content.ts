...
export const DOCS_DEPLOYMENT_GUIDES = [
  {
    ...
    href: "https://github.com/batuhanozkose/OzRouter/blob/main/docs/TERMUX_GUIDE.md",
  },
] as const;
...
export const DOCS_MCP_TOOL_GROUPS = [
  ...
  },
  {
    ...
    tools: ["ozrouter_cache_stats", "ozrouter_cache_flush"],
  },
  {
    titleKey: "mcpToolsMemoryTitle",
    textKey: "mcpToolsMemoryDesc",
    tools: ["ozrouter_memory_search", "ozrouter_memory_add", "ozrouter_memory_clear"],
  },
  {
    titleKey: "mcpToolsSkillsTitle",
    textKey: "mcpToolsSkillsDesc",
    tools: [
      "ozrouter_skills_list",
      "ozrouter_skills_enable",
      "ozrouter_skills_execute",
      "ozrouter_skills_executions",
    ],
  },
] as const;
