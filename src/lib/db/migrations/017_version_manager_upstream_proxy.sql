...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'ozrouter'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with OzRouter
...
-- Determines whether each provider uses OzRouter's native executor,
