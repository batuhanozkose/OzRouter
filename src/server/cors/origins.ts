 ...
 *
 * Source of truth for which browser origins may call OzRouter over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-ozrouter-connection, x-internal-test, accept";
