/**
 * Global Type Declarations for OzRouter
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    OZROUTER_PUBLIC_BASE_URL?: string;
    OZROUTER_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    OZROUTER_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    OZROUTER_BASE_URL?: string;
    OZROUTER_DISABLE_BACKGROUND_SERVICES?: string;
    OZROUTER_PORT?: string;
