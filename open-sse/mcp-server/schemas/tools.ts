/**
 * MCP Tool Schemas — Contracts for all 22 core and advanced OzRouter MCP tools.
 *
 ...
 *
 * Each tool wraps existing OzRouter API endpoints and exposes them through
...
export interface McpToolDefinition<TInput extends z.ZodTypeAny, TOutput extends z.ZodTypeAny> {
  ...
  phase: 1 | 2;
  /** Source endpoints on OzRouter that this tool wraps */
  sourceEndpoints: readonly string[];
}

// ============ Phase 1: Essential Tools (8) ============

// --- Tool 1: ozrouter_get_health ---
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "ozrouter_get_health",
  description:
    "Returns the current health status of OzRouter including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: ozrouter_get_combo_metrics ---
...
> = {
  name: "ozrouter_get_combo_metrics",
  description:
...
> = {
  ...
  description:
    "Sends a chat completion request through OzRouter's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: ozrouter_list_models_catalog ---
...
> = {
  name: "ozrouter_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  ...
  description:
    "Performs a web search using OzRouter's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
// --- Tool 9: ozrouter_simulate_route ---
...
// --- Tool 10: ozrouter_set_budget_guard ---
...
> = {
  name: "ozrouter_set_budget_guard",
  description:
...
// --- Tool 11: ozrouter_set_routing_strategy ---
...
> = {
  name: "ozrouter_set_routing_strategy",
  description:
...
// --- Tool 12: ozrouter_set_resilience_profile ---
...
> = {
  name: "ozrouter_set_resilience_profile",
  description:
...
// --- Tool 14: ozrouter_get_provider_metrics ---
...
> = {
  name: "ozrouter_get_provider_metrics",
  description:
...
// --- Tool 15: ozrouter_best_combo_for_task ---
...
> = {
  name: "ozrouter_best_combo_for_task",
  description:
...
// --- Tool 16: ozrouter_explain_route ---
...
// --- Tool 17: ozrouter_get_session_snapshot ---
...
> = {
  name: "ozrouter_get_session_snapshot",
  description:
...
// --- Tool 18: ozrouter_db_health_check ---
...
> = {
  name: "ozrouter_db_health_check",
  description:
    "Diagnoses OzRouter database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "ozrouter_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into OzRouter. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
