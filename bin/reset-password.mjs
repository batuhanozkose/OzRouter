 ...
 *   npx ozrouter reset-password
 *
 * Resets the admin password for OzRouter.
...
console.log("\n🔑 OzRouter — Password Reset\n");

async function main() {
  // Check if database exists
  if (!existsSync(DB_PATH)) {
    console.error(`❌ Database not found at: ${DB_PATH}`);
    console.error(`   Make sure OzRouter has been started at least once.`);
  ...
  console.log("   Restart OzRouter for changes to take effect.\n");
}
