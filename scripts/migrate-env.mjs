...
/**
 * OzRouter v3.3 -> v3.4 Environment Migration Script
...
if (modified) {
  ...
  console.log("Successfully migrated .env file for OzRouter 3.4.x.");
} else {
  console.log(".env file is already compatible with OzRouter 3.4.x.");
}
